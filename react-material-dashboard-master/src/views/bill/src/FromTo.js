    ...
    return (
      <form onSubmit={this.onSubmitinvoice} >
        ...
        <div className='to'>
          ...
          <div className="card-group  mb-2 ">
            <div class="card mr-1   col-lg-6" >
              ...
              <div class="card-body ">
                ...
                <p> AK-{this.props.curentinvoice.id}</p>
              </div>
            </div>
            <div class="card  mr-1" >
              ...
              <div class="card-body">
                ...
                {/* <DatePicker  selected={this.state.startdate} onChange={this.onChangeDate}  customInput={<ExampleCustomInput />}/> */}
            ...
            <div class="card-body">
              {
                !this.state.disableGenerate ?
                  ...
                  <select class="custom-select customselect" disabled={this.state.disableGenerate} required onChange={this.onChangeProgram}>
                    <option >{this.state.program}</option>
              ...
              <div class="card-body " style={{ display: "flex", justifyContent: "center" }}>
                {
                  !this.state.disableGenerate ?
                    ...
                    : <p>{this.convert(this.state.startdate)}</p>}
              </div>
            </div>
          </div>
          <div class="card mb-4  " style={{height:140}}>
            <div class="card-header  ">PROGRAM ID</div>
            <div class="card-body">

              <p>{this.convert(this.state.startdate) + "|" + this.state.program + "|" + this.state.customer_name + "|" + this.state.owner}</p>
            </div>
          </div>
          ...
          {/* <div className="row"> 
        <div class="form-group col-lg-6 a">
    <label for="exampleInputEmail1" className="b">Email address</label>
    <p
