            ...
            <form onSubmit={this.onSubmitreceipt} >
              <div className='from-to mt-4'>
                  ...
                  <div class="card  mt-2 " style={{ height: 450 }} >
                    ...
                    <div class="card-body ">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="text" required class="form-control datepica " disabled value={this.state.invoice.customer_name} />
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="staticEmail" class="col-sm-2 col-form-label">NIC</label>
                        <div class="col-sm-10">
                          <input type="text" required class="form-control datepica" disabled value={this.state.invoice.nic} />
                        </div>
                      </div><div class="form-group row">
                        <label for="staticEmail" class="col-sm-2 col-form-label">Phone</label>
                        <div class="col-sm-10">
                          <input type="text" required class="form-control datepica" disabled value={this.state.invoice.phonenumber} />
                        </div>
                      </div>
                      <div class="form-group row">
                ...
                <div className='to'>
                  ...
                  <a href="/print_receipt">  <button type="button" class="btn MT-2 btn-primary btn-lg generate btn-block" disabled={!this.state.isprint} > PRINT</button></a>
